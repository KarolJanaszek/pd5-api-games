...
public class Weather {
    ...
    @JsonProperty("parent")
    private WeatherParent parent;
    @JsonProperty("sources")
    private List<WeatherSource> sources = null;
    @JsonProperty("title")
    ...
    @JsonProperty("parent")
    public WeatherParent getParent() {
        return parent;
    }

    @JsonProperty("parent")
    public void setParent(WeatherParent parent) {
        this.parent = parent;
    }

    @JsonProperty("sources")
    public List<WeatherSource> getSources() {
        return sources;
    }

    @JsonProperty("sources")
    public void setSources(List<WeatherSource> sources) {
